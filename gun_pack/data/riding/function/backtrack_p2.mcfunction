data modify storage gunpack:riding p2.apos set from entity @s Pos
execute store result score #x riding run data get storage gunpack:riding p2.bpos[0]
execute store result score #z riding run data get storage gunpack:riding p2.bpos[2]
execute store result score #x_after riding run data get storage gunpack:riding p2.apos[0] 1000
execute store result score #z_after riding run data get storage gunpack:riding p2.apos[2] 1000
...
execute store result score #xna riding run data get storage gunpack:riding p2.bpos[0] 1000
